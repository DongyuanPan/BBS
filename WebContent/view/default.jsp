						...
						<table rules="none" border="1" width="100%" cellspacing="0"
							...
							<tr height="30">
								<td style="text-indent: 5" background="images/index/classT.jpg"><b><font
										color="white">■ <bean:write name="classSingle"
												property="className" /></font></b></td>
							</tr>
							<tr bgcolor="#F9F9F9">
								<td height="60" align="center"><logic:notPresent
										name="class${classSingle.classId}">
										<li>该论坛类别暂无版面显示！</li>
									</logic:notPresent> <logic:present name="class${classSingle.classId}">
										<logic:notEmpty name="class${classSingle.classId}">
											<logic:iterate id="boardSingle"
												name="class${classSingle.classId}" scope="session">
												<table border="1" width="100%" cellspacing="0"
													cellpadding="4" bgcolor="#F9F9F9" bordercolor="#EEEEEE"
													bordercolorlight="#EEEEEE" bordercolordark="white"
													rules="cols">
													<tr height="35">
