...
<table border="0">
	<tr>
		<td><img src="images/index/bfn.gif" onclick="bold(content)">
			<img src="images/index/ifn.gif" onclick="italic(content)"> <img
			src="images/index/ufn.gif" onclick="line(content)"> 字体： <SELECT
			onChange="showface(content,this.options[this.selectedIndex].value)">
			...
			onChange="showsize(content,this.options[this.selectedIndex].value)">
			...
			onChange="showcolor(content,this.options[this.selectedIndex].value)">
				<option style="background-color: black; color: black" value="black"
					selected>黑色</option>
				...
				<option style="background-color: purple; color: purple"
					value="purple">		紫色</option>
				...
				<option style="background-color: orange; color: orange"
					value="orange">		橘黄</option>
		</SELECT></td>
	</tr>
</table>

<div id="User"
	style="position: absolute; width: 240px; height: 139px; display: none;">
