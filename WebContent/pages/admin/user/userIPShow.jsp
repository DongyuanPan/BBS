	...
	<center>
		...
		<html:form action="needLogin/admin/getUserList.do">
			...
			<table border="0" width="580" cellspacing="0" cellpadding="0">
				<tr>
					<td align="right">选择用户权限： <html:select property="showAble">
							<html:option value="-1">--请选择用户权限--</html:option>
							<html:options collection="backListAble" property="value"
								labelProperty="label" />
					...
					<tr>
						<td colspan="6">
							<table border="1" width="100%" cellspacing="0" cellpadding="0"
								...
								bordercolordark="white" rules="rows">
								<logic:iterate id="backUserSingle" name="backUserList"
									indexId="ind">
                                    ...
                                    普通用户
                                </logic:equal> <logic:equal name="backUserSingle"
												property="userAble" value="1">
                                    版主
                                </logic:equal> <logic:equal name="backUserSingle"
                                    ...
                                    管理员
										...
										<td align="center"><a
											href="needLogin/admin/deleteUser.do?method=deleteUser&userId=${backUserSingle.id}"
