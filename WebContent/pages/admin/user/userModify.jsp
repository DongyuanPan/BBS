	...
	<center>
		...
		<html:form action="needLogin/admin/modifyUser.do">
			...
			<table border="0" width="90%" height="630" cellspacing="0"
				cellpadding="0">
				<tr height="60">
					<td colspan="4" style="text-indent: 5">■ 修改用户信息</td>
				</tr>
				<tr height="70">
					...
					<td colspan="2" rowspan="2" valign="bottom"
						...
						src="images/face/user/${userForm.userFace}"></td>
				</tr>
				<tr>
					<td align="right">用户头像：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td colspan="2"><html:select property="userFace"
							onchange="showHead(this.options[this.selectedIndex].value)">
							<html:options collection="headFace" property="value"
				...
				<tr>
					...
					<td><html:radio property="userSex" value="男" />男 <html:radio
							property="userSex" value="女" />女</td>
					<td align="right">用户权限：&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td><html:select property="userAble">
							<html:options collection="backUserAble" property="value"
								labelProperty="label" />
						</html:select></td>
				</tr>
				<tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td colspan="3"><html:submit value="修改用户" /> <html:reset
							value="重新填写" /></td>
				</tr>
			</table>
		</html:form>
