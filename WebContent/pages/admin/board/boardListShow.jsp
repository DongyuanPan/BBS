	...
	<center>
		...
		<html:form action="needLogin/admin/getBoardList.do">
			...
			<table border="0" width="580" cellspacing="0" cellpadding="0">
				<tr>
					<td align="right">选择论坛类别： <html:select property="classId">
							<html:option value="-1">--请选择论坛类别--</html:option>
							<html:optionsCollection name="backClassList" value="classId"
								label="className" />
						</html:select> <html:submit value="显示" />
					</td>
				</tr>
			</table>
		</html:form>
		...
		<table border="1" width="580" cellspacing="0" cellpadding="0"
			...
			<logic:notPresent name="backBoardList">
				<tr height="80" align="center" bgcolor="#FBFBFB">
					<td colspan="5"><li>没有版面可显示！</li></td>
				</tr>
			</logic:notPresent>
							...
							<table border="1" width="100%" cellspacing="0" cellpadding="0"
								...
								<logic:iterate id="backBoardSingle" name="backBoardList">
									<tr height="35" bgcolor="#FBFBFB">
										...
										<td width="40%" style="text-indent: 5"><a
											href="needLogin/admin/modifyBoard.do?method=modifyBoard&boardId=${backBoardSingle.boardId}"><bean:write
													name="backBoardSingle" property="boardName" filter="false" /></a></td>
										<td width="25%" align="center"><a
											href="bbs/user/getUserSingle.do?method=getUserSingle&userName=${backBoardSingle.boardMaster}"><bean:write
													name="backBoardSingle" property="boardMaster" /></a></td>
										<td align="center"><a
											href="needLogin/admin/modifyBoard.do?method=modifyBoard&boardId=${backBoardSingle.boardId}">√修改</a></td>
										<td align="center"><a
											href="needLogin/admin/deleteBoard.do?method=deleteBoard&boardId=${backBoardSingle.boardId}"
