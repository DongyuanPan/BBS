	...
	<center>
		...
		<html:form action="needLogin/admin/modifyBoard.do">
			...
			<table border="0" width="90%" cellspacing="0" cellpadding="0"
				...
				bordercolordark="white" rules="none">
				<tr height="60">
					<td colspan="2" style="text-indent: 5">■ 修改版面</td>
				</tr>
				<tr height="50">
					<td align="right" width="30%">版面ID：&nbsp;&nbsp;</td>
					<td style="text-indent: 5"><html:hidden property="boardId"
							write="true" /></td>
				</tr>
				<tr>
					<td align="right" width="30%">所属类别：&nbsp;&nbsp;</td>
					<td><html:select property="boardClassID">
				...
				<tr height="50">
					<td>&nbsp;</td>
					<td><html:submit value="修改" /> <html:reset value="重置" /></td>
				</tr>
			</table>
		</html:form>
	</center>
