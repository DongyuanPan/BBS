	...
	<center>
		<table border="1" width="80%" bgcolor="#F9F9F9" cellspacing="0"
			...
			<html:form action="user/reg.do">
				...
				<tr height="80">
					<td colspan="5" style="text-indent: 20">■ 用户注册</td>
				</tr>
				<tr height="45">
				...
				<tr height="45">
					...
					<td colspan="4"><html:password property="userPassword"
				...
				<tr height="45">
					...
					<td rowspan="3" width="20%" valign="bottom"
						...
						src="images/face/user/user0.gif" style="border: 1 solid"></td>
				</tr>
				<tr>
					<td></td>
				...
				<tr height="80">
					<td>&nbsp;</td>
					<td colspan="4"><html:submit value="用户注册" /> <html:submit
							value="重新填写" /></td>
				</tr>
			</html:form>
		</table>
