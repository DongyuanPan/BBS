...
<body>
	<center>
		<table border="1" width="100%" cellspacing="0" cellpadding="0"
			bordercolor="#E0E0E0" bordercolorlight="#E3E3E3"
			bordercolordark="white" rules="rows" style="margin-top: 8">
			<tr height="45" bgcolor="#F9F9F9">
				<!-- 版面公告 -->
				<td colspan="4" style="text-indent: 10">版面公告：<bean:write
						name="boardPcard" filter="false" />
				</td>
				<!-- “发表帖子”超链接 -->
				<td colspan="2" align="center"><a
					href="needLogin/addBbs.do?method=addBbs">[发表帖子]</a></td>
			</tr>
			...
			<logic:notPresent name="topbbslist" scope="session">
				<tr height="70">
					<td bgcolor="#F9F9F9" align="center" colspan="6"><font
						color="red"><li>置顶帖子列表不存在！</li></font></td>
				</tr>
			</logic:notPresent>
			<!-- 置顶帖子列表存在 -->
			<logic:present name="topbbslist" scope="session">
				...
				<logic:empty name="topbbslist" scope="session">
					<tr height="70">
						<td bgcolor="#F9F9F9" align="center" colspan="6"><font
							color="red"><li>没有置顶帖子！</li></font></td>
					</tr>
				</logic:empty>
				<!-- 置顶帖子列表不为空 -->
							...
							<table border="1" width="100%" cellspacing="0" cellpadding="0"
								...
								<logic:iterate id="topBbsSingle" name="topbbslist">
									<tr height="35" style="text-indent: 5" bgcolor="#FBFBFB">
										...
										<td width="35%" style="text-indent: 10"><img
											src="images/face/bbs/${topBbsSingle.bbsFace}"> <a
											href="user/openShow.do?method=openShow&showpage=1&bbsId=${topBbsSingle.bbsId}"><bean:write
													name="topBbsSingle" property="subBbsTitle[18]"
													filter="false" /></a></td>
										<td width="7%" align="center"><bean:write
												name="topBbsSingle" property="bbsAnswerNum" /></td>
			...
			<logic:notPresent name="otherbbslist" scope="session">
				<tr height="180">
					<td bgcolor="#F9F9F9" align="center" colspan="6"><font
						color="red"><li>对不起，帖子列表不存在！</li></font></td>
				</tr>
			</logic:notPresent>
			<!-- 普通帖子列表存在 -->
							...
							<table border="1" width="100%" cellspacing="0" cellpadding="0"
								...
								<logic:iterate id="otherBbsSingle" name="otherbbslist">
									<tr height="35" bgcolor="#F9F9F9">
										<!-- 输出帖子状态 -->
										<td align="center" width="8%"><logic:equal value="1"
												name="otherBbsSingle" property="bbsIsGood">
                            	    		  精华
		                        	      </logic:equal> <logic:equal value="0"
												name="otherBbsSingle" property="bbsIsGood">
                		                	  普通
	                        		      </logic:equal></td>
										<!-- 输出帖子标题 -->
										<td style="text-indent: 10" width="35%"><img
											src="images/face/bbs/${otherBbsSingle.bbsFace}"> <a
											href="user/openShow.do?method=openShow&showpage=1&bbsId=${otherBbsSingle.bbsId}"><bean:write
													name="otherBbsSingle" property="subBbsTitle[18]"
													filter="false" /></a></td>
										<!-- 输出帖子回复数 -->
										<td align="center" width="7%"><bean:write
												name="otherBbsSingle" property="bbsAnswerNum" /></td>
										<!-- 输出帖子发表者 -->
