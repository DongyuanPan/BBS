	...
	<center>
		<table border="1" width="100%" cellspacing="0" cellpadding="0"
			...
			<logic:notPresent name="goodlist" scope="session">
				<tr height="180">
					<td bgcolor="#F9F9F9" align="center" colspan="5"><li>对不起，帖子列表不存在！</li></td>
				</tr>
			</logic:notPresent>
								...
								<logic:iterate id="goodSingle" name="goodlist">
									<tr height="35" bgcolor="#F9F9F9">
										...
										<td width="35%" style="text-indent: 10"><img
											src="images/face/bbs/${goodSingle.bbsFace}"> <a
											href="user/openShow.do?method=openShow&bbsId=${goodSingle.bbsId}"><bean:write
													name="goodSingle" property="subBbsTitle[18]" filter="false" /></a>
										</td>
										<td width="7%" align="center"><bean:write
												name="goodSingle" property="bbsAnswerNum" /></td>
			...
			<tr height="30">
				<td colspan="6" background="images/index/boardE.jpg"><jsp:include
						...
						<jsp:param name="gowhich"
							value="user/goodListShow.do?method=goodListShow" />
					</jsp:include></td>
			</tr>
			<tr height="10">
				<td colspan="5"></td>
