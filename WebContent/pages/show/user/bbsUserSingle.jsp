...
<body>
	<center>
		<table border="1" width="70%" bgcolor="#F9F9F9" cellspacing="0"
			cellpadding="0" bordercolor="lightgrey" bordercolorlight="lightgrey"
			bordercolordark="white" rules="none" style="margin-top: 8">
			<tr height="60">
				<td colspan="2" style="text-indent: 5">■ 查看用户信息</td>
			</tr>
			<tr height="50">
				<td align="right">用户头像：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td><img src="images/face/user/${bbsUserSingle.userFace}"
			...
			<tr height="50">
				...
				<td><logic:equal value="0" name="bbsUserSingle"
						property="userAble">普通用户</logic:equal> <logic:equal value="1"
						name="bbsUserSingle" property="userAble">版主</logic:equal> <logic:equal
						value="2" name="bbsUserSingle" property="userAble">管理员</logic:equal>
				</td>
			</tr>
			<tr height="50">
